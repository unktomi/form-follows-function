...
public class RigidBody extends CollisionObject {
	...
	private float inverseMass;
        private Vector3f angularFactor = new Vector3f();
        private Vector3f linearFactor = new Vector3f();
	...
	public void applyImpulse(Vector3f impulse, Vector3f rel_pos) {
			...
			if (!VectorUtil.isZero(angularFactor)) {
				...
				VectorUtil.mul(tmp, angularFactor, tmp);
	...
	public void internalApplyImpulse(Vector3f linearComponent, Vector3f angularComponent, float impulseMagnitude) {
		...
		if (inverseMass != 0f) {
                    ...
                    if (!VectorUtil.isZero(angularFactor)) {
                        ...
                        angularFactor.scale(impulseMagnitude, tmp);
	...
	public void setLinearFactor(Vector3f fac) {
               linearFactor.set(fac);
	}
