...
public class GLShapeDrawer {
	...
	private static final ObjectPool<Transform> transformsPool = ObjectPool.get(Transform.class);
	private static final ObjectPool<Vector3f> vectorsPool = ObjectPool.get(Vector3f.class);
