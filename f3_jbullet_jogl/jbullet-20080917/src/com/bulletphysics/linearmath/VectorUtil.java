...
public class VectorUtil {
    ...
    public static float triple(Vector3f src, Vector3f v1, Vector3f v2) {
        return src.x * (v1.y * v2.z - v1.z * v2.y) + 
    ...
    public static Vector3f times(Transform transform, Vector3f vec) {
    ...
    public static Vector3f minus(Vector3f v1, Vector3f v2) {
        Vector3f dest = new Vector3f();
        dest.sub(v1, v2);
        return dest;
    }

    public static Vector3f times(Vector3f v1, float scaleFactor) {
        Vector3f dest = new Vector3f(v1);
        dest.scale(scaleFactor);
        return dest;
    }
}
