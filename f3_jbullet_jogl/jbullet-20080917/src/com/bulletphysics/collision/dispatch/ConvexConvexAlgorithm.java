...
public class ConvexConvexAlgorithm extends CollisionAlgorithm {
	...
	protected static final ObjectPool<ClosestPointInput> pointInputsPool = ObjectPool.get(ClosestPointInput.class);
...
//	#else
		...
		gjkPairDetector.init(min0, min1, simplexSolver, pdSolver);
		...
		//	input.m_maximumDistanceSquared = btScalar(1e30);
                //input.maximumDistanceSquared = Float.MAX_VALUE;
	...
	private static ObjectPool<ConvexConvexAlgorithm> pool = ObjectPool.get(ConvexConvexAlgorithm.class);
