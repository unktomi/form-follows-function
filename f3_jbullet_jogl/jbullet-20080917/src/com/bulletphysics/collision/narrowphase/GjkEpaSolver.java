...
import com.bulletphysics.collision.narrowphase.GjkEpaSolver.EPA.Face;
import com.bulletphysics.collision.narrowphase.GjkEpaSolver.GJK.He;
import com.bulletphysics.collision.narrowphase.GjkEpaSolver.GJK.Mkv;
...
public class GjkEpaSolver {
	...
	protected static final ArrayPool<float[]> floatArrays = ArrayPool.get(float.class);
	...
	private static GJK gjk = new GJK();
        private static EPA epa = new EPA(gjk);
