...
public class GjkPairDetector extends DiscreteCollisionDetectorInterface {
	...
	public void getClosestPoints(ClosestPointInput input, Result output, IDebugDraw debugDraw, boolean swapResults) {
		...
		//printf("gjk add:%f",distance);
                        //                        System.out.println("GJK valid "+ distance);
                        //                        System.out.println("point on b " + pointOnB.x + " " + pointOnB.y + " " + pointOnB.z);
                        //                        System.out.println("normal: " + normalInB.x + " " + normalInB.y + " " + normalInB.z);
		} else {
                    //                    System.out.println("GJK not valid....");
                }
	}
