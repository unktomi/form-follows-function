...
public class TriangleIndexVertexArray extends StridingMeshInterface {
	...
	public TriangleIndexVertexArray(int numTriangles, ByteBuffer triangleIndexBase, int triangleIndexStride, int numVertices, ByteBuffer vertexBase, int vertexStride) {
            this(numTriangles, 
                 triangleIndexBase.asIntBuffer(),
                 triangleIndexStride, numVertices,
                 vertexBase.asFloatBuffer(),
                 vertexStride);
        }
	public TriangleIndexVertexArray(int numTriangles, IntBuffer triangleIndexBase, int triangleIndexStride, int numVertices, FloatBuffer vertexBase, int vertexStride) {
