...
class Start {
    ...
    private static final String f3docName = "f3doc";

    private static final String standardDocletClassName =
        "org.f3.tools.xmldoclet.XMLDoclet";
    ...
    private static final String versionRBName =
            "org.f3.tools.f3doc.resources.version";
    ...
    private boolean parseAndExecute(String argv[]) throws IOException {
        ...
        F3docTool comp = F3docTool.make0(context);
