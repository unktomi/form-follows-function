...
public class FieldDocImpl extends MemberDocImpl implements FieldDoc {
    ...
    public FieldDocImpl(DocEnv env, VarSymbol sym,
                        String rawDocs, F3Var tree, Position.LineMap lineMap) {
    ...
    public boolean isPublicRead() {
        return (getFlags() & F3Flags.PUBLIC_READ) != 0;
    }
    ...
    public boolean isPublicInit() {
        return (getFlags() & F3Flags.PUBLIC_INIT) != 0;
    }
    ...
    public boolean isDef() {
        return (getFlags() & F3Flags.IS_DEF) != 0;
    }
