...
public class TypeMaker {
    ...
    public static com.sun.javadoc.Type getType(DocEnv env, Type t,
        ...
        case FLOAT: 
            if (env.syms instanceof F3Symtab) {
                if (env.types.isSameType(((F3Symtab)env.syms).f3_NumberType, env.syms.floatType)) {
        ...
        case DOUBLE: 
            if (env.syms instanceof F3Symtab) {
                if (env.types.isSameType(((F3Symtab)env.syms).f3_NumberType, env.syms.doubleType)) {
                    return PrimitiveType.numberType;
                }
            }
