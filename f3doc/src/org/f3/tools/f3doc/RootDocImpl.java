...
public class RootDocImpl extends DocImpl implements RootDoc {
     ...
     */
    public RootDocImpl(DocEnv env, List<F3ClassDeclaration> classes, List<String> packages, List<String[]> options) {
        super(env, null);
     ...
     */
    private void setClasses(DocEnv env, List<F3ClassDeclaration> classes) {
        ListBuffer<ClassDocImpl> result = new ListBuffer<ClassDocImpl>();
        for (F3ClassDeclaration def : classes) {
