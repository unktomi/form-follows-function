...
const char * NULL_FMOD_ADVANCEDSETTINGS =			"";
const char * NULL_CHANNEL =							"";
const char * NULL_CHANNELGROUP =					"";
const char * NULL_DSP =								"";
const char * NULL_DSPCONNECTION =					"";
const char * NULL_GEOMETRY =						"";
const char * NULL_REVERB =							"";
const char * NULL_SOUND =							"";
const char * NULL_SOUNDGROUP =						"";
const char * NULL_SYSTEM =							"";
const char * NULL_FMOD_CDTOC =						"";
const char * NULL_FMOD_CREATESOUNDEXINFO =			"";
const char * NULL_FMOD_DSP_DESCRIPTION =			"";
const char * NULL_FMOD_DSP_PARAMETERDESC =			"";
const char * NULL_FMOD_DSP_STATE =					"";
const char * NULL_FMOD_REVERB_CHANNELPROPERTIES =	"";
const char * NULL_FMOD_REVERB_PROPERTIES =			"";
const char * NULL_FMOD_TAG =						"";
const char * NULL_FMOD_VECTOR =						"";
const char * NULL_FMOD_GUID =						"";
const char * NULL_OBJECT_POINTER =					"";
const char * NULL_POINTER =							"";
const char * NULL_BUFFER =							"";
const char * NULL_FMOD_CODEC_WAVEFORMAT =			"";
const char * NULL_FMOD_CODEC_STATE =				"";
const char * NULL_FMOD_CODEC_DESCRIPTION =			"";
