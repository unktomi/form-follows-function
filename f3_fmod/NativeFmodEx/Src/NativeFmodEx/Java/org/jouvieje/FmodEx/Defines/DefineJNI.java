...
class DefineJNI
{
	...
	protected final static int get_NATIVEFMODEX_JAR_VERSION()
	{
		//TODO NATIVEFMODEX_JAR_VERSION version
		return 0x00010404;
		//TODO NATIVEFMODDESIGNER_JAR_VERSION version !!!
	}
	
	protected final static native int get_FMOD_VERSION();
	protected final static native int get_NATIVEFMODEX_VERSION();
}