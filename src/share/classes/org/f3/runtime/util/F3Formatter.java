 ...
 *   F3Formatter formatter = new F3Formatter(sb, Locale.US);
 *
 ...
 *     <tt>long</tt>, {@link Long}, and {@link Date} the  time zone used is
 *     the {@plainlink TimeZone#getDefault() default time zone} for this
 *     instance of the Java virtual machine.  The F3Formatter's locale will
 ...
 * methods of <tt>F3Formatter</tt> as well as by any <tt>format</tt> convenience
 ...
 * @author  Iris Clark
 */
public final class F3Formatter implements Closeable, Flushable {
     ...
     */
    public F3Formatter(Appendable a) {
        if (a == null)
            a = new StringBuilder();
     ...
     *         is applied.
     */
    public F3Formatter(Appendable a, Locale l) {
        if (a == null)
            a = new StringBuilder();
        init(a, l);
    }
     ...
     *          creating the file
     */
    public F3Formatter(String fileName) throws FileNotFoundException {
     ...
     */
    public F3Formatter(String fileName, String csn)
     ...
     *          If the named charset is not supported
     */
    public F3Formatter(String fileName, String csn, Locale l)
        throws FileNotFoundException, UnsupportedEncodingException
    {
     ...
     *          creating the file
     */
    public F3Formatter(File file) throws FileNotFoundException {
     ...
     *          If the named charset is not supported
     */
    public F3Formatter(File file, String csn)
        throws FileNotFoundException, UnsupportedEncodingException
    {
     ...
     *          If the named charset is not supported
     */
    public F3Formatter(File file, String csn, Locale l)
        throws FileNotFoundException, UnsupportedEncodingException
    {
     ...
     */
    public F3Formatter(PrintStream ps) {
        if (ps == null)
     ...
     */
    public F3Formatter(OutputStream os) {
     ...
     *          If the named charset is not supported
     */
    public F3Formatter(OutputStream os, String csn)
        throws UnsupportedEncodingException
    {
     ...
     *          If the named charset is not supported
     */
    public F3Formatter(OutputStream os, String csn, Locale l)
        throws UnsupportedEncodingException
    {
     ...
     */
    public F3Formatter format(String format, Object ... args) {
        return format(l, format, args);
    }

    public static final String sprintf(String format, Object... args) {
        return new F3Formatter().format(format, args).toString();
    }

    public static final String sprintf(Locale l, String format, Object... args) {
        return new F3Formatter().format(l, format, args).toString();
    }
     ...
     * @return  This formatter
     */
    public F3Formatter format(Locale l, String format, Object ... args) {
        ensureOpen();
    ...
    private class FormatSpecifier implements FormatString {
        ...
        private void printDateTime(Object arg, Locale l) throws IOException {
            ...
            if (arg instanceof Long) {
                ...
                try {
                    // As of build time, f3.date.DateTime isn't available.
                    Class clazz = Class.forName("f3.date.DateTime");
                    ...
                    if (argClass.isAssignableFrom(clazz)) {
                        try {
                            ...
                            Field tzField = getField(argClass, "$f3$date$DateTime$tz");
