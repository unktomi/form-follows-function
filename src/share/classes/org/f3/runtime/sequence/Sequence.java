...
public interface Sequence<T> extends Iterable<T>, MonadZero<Sequence, T>, MonadPlus<Sequence, T>, Comonad<Sequence, T>, Foldable<T>, Accumulative<T> {
    ...
    public Sequence<? extends T> reverse();
    //public <S super T> Sequence<S> prepend(S x);
    public Sequence<T> prepend(Object x);
    //public <S super T> Sequence<S> append(S x);
    public Sequence<T> append(Object x);
