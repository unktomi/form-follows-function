 ...
 * @author Robert Field
 */
public class F3InitDefinition extends F3Tree implements InitDefinitionTree{
    public F3Block body;
    public MethodSymbol sym;

    protected F3InitDefinition(F3Block body) {
        this.body = body;
    }
    ...
    public F3Tag getF3Tag() {
        return F3Tag.INIT_DEF;
    }

    public F3Kind getF3Kind() {
        return F3Kind.INIT_DEFINITION;
    }
