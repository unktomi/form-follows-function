 ...
 * @author Robert Field
 */
public class F3SequenceEmpty extends F3AbstractSequenceCreator implements SequenceEmptyTree {

    public F3SequenceEmpty() {
    }
    ...
    public F3Tag getF3Tag() {
        return F3Tag.SEQUENCE_EMPTY;
    }

    public F3Kind getF3Kind() {
        return F3Kind.SEQUENCE_EMPTY;
    }
