...
/**
 * F3PostInitDefinition
 *
 * @author Brian Goetz
 */
public class F3PostInitDefinition extends F3Tree implements InitDefinitionTree {
    public F3Block body;
    public Symbol.MethodSymbol sym;

    protected F3PostInitDefinition(F3Block body) {
        this.body = body;
    }
    ...
    public F3Tag getF3Tag() {
        return F3Tag.POSTINIT_DEF;
    }

    public F3Kind getF3Kind() {
        return F3Kind.POSTINIT_DEFINITION;
    }
