 ...
 * A throw statement.
 */
public class F3ErroneousThrow extends F3Throw {
    /**
    ...
    protected F3ErroneousThrow() {
        errNode = new F3Erroneous(List.<F3Tree>nil());
    }
    protected F3ErroneousThrow(List<? extends F3Tree> errs) {
