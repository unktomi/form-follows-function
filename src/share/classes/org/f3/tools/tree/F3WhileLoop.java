 ...
 * A while loop
 */
public class F3WhileLoop extends F3Expression implements WhileLoopTree {

    public final F3Expression cond;
    public final F3Expression body;

    protected F3WhileLoop(F3Expression cond, F3Expression body) {
        this.cond = cond;
        this.body = body;
    }
