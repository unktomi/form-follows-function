...
public class Function12<R, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12> extends Function<R> {
    public Function12() {}
    
    public Function12(final F3Object implementor, final int number) {
    ...
    public Object invoke$(Object arg1, Object arg2, Object[] rargs) {
        if (implementor != null) {
            ...
            return invoke((A1)arg1, (A2)arg2, (A3)rargs[0], (A4)rargs[1], (A5)rargs[2], (A6)rargs[3], (A7)rargs[4], (A8)rargs[5], 
			  (A9)rargs[6], (A10)rargs[7], (A11)rargs[8], (A12)rargs[9]);
        }
    }
    
    // Override this
    public R invoke(A1 x1, A2 x2, A3 x3, A4 x4, A5 x5, A6 x6, A7 x7, A8 x8, A9 x9, A10 x10, A11 x11, A12 x12) {
        if (implementor != null) {
            return (R) implementor.invoke$(number, x1, x2, new Object[] { x3, x4, x5, x6, x7, x8, x9, x10, x11, x12 });
        } else {
