...
public interface Keys {
    ...
    public static final int PauseBreak = 19;
    ...
    public static final int RightClick = 93;

    //    public static final int Num = for (i in [96..<106]) i;
    ...
    public static final int Backtick = 191;
}
