...
/**
 * This is a command line debugger for F3 programs. This class is same as
 * the main class of "jdb" tool except that this one uses F3-JDI launching
...
public class TTY implements EventNotifier {
     ...
     */
    private static final String progname = "f3db";
                ...
                if (commandNumber < 0) {
                    ...
                    try {
                        if (cmd.equals("print")) {
                            ...
                            evaluator.commandConnectors(F3Bootstrap.virtualMachineManager());
                            ...
                            evaluator.commandVersion(progname,
                                                     F3Bootstrap.virtualMachineManager());
    ...
    private static boolean supportsSharedMemory() {
        for (Connector connector :
                 F3Bootstrap.virtualMachineManager().allConnectors()) {
    ...
    public static void main(String argv[]) throws MissingResourceException {
        ...
        for (int i = 0; i < argv.length; i++) {
            ...
            if (token.equals("-dbgtrace")) {
                ...
                /*
                 * -attach is shorthand for one of the F3-JDI implementation's
