 ...
 * @author sundar
 */
public class F3ClassPrepareEvent extends F3Event implements ClassPrepareEvent {
    public F3ClassPrepareEvent(F3VirtualMachine f3vm, ClassPrepareEvent underlying) {
