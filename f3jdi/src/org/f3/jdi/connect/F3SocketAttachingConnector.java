 ...
 * @author sundar
 */
public class F3SocketAttachingConnector extends F3Connector implements AttachingConnector {
    public F3SocketAttachingConnector() {
        this(makePlatformConnector());
    }

    public F3SocketAttachingConnector(AttachingConnector underlying) {
        super(underlying);
    }
