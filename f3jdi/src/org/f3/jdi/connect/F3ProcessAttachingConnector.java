 ...
 * @author sundar
 */
public class F3ProcessAttachingConnector extends F3Connector implements AttachingConnector {
    public F3ProcessAttachingConnector() {
        this(makePlatformConnector());
    }

    public F3ProcessAttachingConnector(AttachingConnector underlying) {
        super(underlying);
    }
