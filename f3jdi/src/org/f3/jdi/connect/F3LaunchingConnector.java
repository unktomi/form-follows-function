 ...
 * @author sundar
 */
public class F3LaunchingConnector extends F3Connector implements LaunchingConnector {
    public F3LaunchingConnector() {
        this(makePlatformConnector());
    }
    
    public F3LaunchingConnector(LaunchingConnector underlying) {
        super(underlying);
    }
