 ...
 * @author sundar
 */
public class F3SharedMemoryListeningConnector extends F3Connector implements ListeningConnector {
    public F3SharedMemoryListeningConnector() {
        this(makePlatformConnector());
    }

    public F3SharedMemoryListeningConnector(ListeningConnector underlying) {
        super(underlying);
    }
