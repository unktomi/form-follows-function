 ...
 * @author sundar
 */
public class F3MonitorContendedEnteredRequest extends F3EventRequest
        implements MonitorContendedEnteredRequest {
    public F3MonitorContendedEnteredRequest(F3VirtualMachine f3vm, MonitorContendedEnteredRequest underlying) {
