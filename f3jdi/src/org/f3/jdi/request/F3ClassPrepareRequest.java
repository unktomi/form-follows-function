 ...
 * @author sundar
 */
public class F3ClassPrepareRequest extends F3EventRequest implements ClassPrepareRequest {
    public F3ClassPrepareRequest(F3VirtualMachine f3vm, ClassPrepareRequest underlying) {
