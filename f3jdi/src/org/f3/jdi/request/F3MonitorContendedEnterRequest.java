 ...
 * @author sundar
 */
public class F3MonitorContendedEnterRequest extends F3EventRequest
        implements MonitorContendedEnterRequest {
    public F3MonitorContendedEnterRequest(F3VirtualMachine f3vm, MonitorContendedEnterRequest underlying) {
