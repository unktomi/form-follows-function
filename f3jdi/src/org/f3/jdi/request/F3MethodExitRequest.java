 ...
 * @author sundar
 */
public class F3MethodExitRequest extends F3EventRequest implements MethodExitRequest {
    public F3MethodExitRequest(F3VirtualMachine f3vm, MethodExitRequest underlying) {
