...
public class UserClassTest extends F3TestBase {
    ReferenceType targetClass;
    ThreadReference mainThread;

    private static final String targetClassName = "org.f3.jdi.test.target.UserClassTarget";
    ...
    void printUser(StackFrame frame, int count) {
        ...
        ClassType userClass = ((F3ReferenceType)rt).f3UserClass();
