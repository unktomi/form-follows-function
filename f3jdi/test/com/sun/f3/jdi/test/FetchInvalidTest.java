...
public class FetchInvalidTest extends F3TestBase {
    ReferenceType targetClass;
    ThreadReference mainThread;

    private static final String targetClassName = "org.f3.jdi.test.target.FetchInvalidTarget";
    ...
    protected void runTests() throws Exception {
        ...
        writeActual("  last exception = " + ((F3VirtualMachine)vm()).lastFieldAccessException());
