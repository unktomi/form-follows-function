...
import org.f3.api.tree.ParenthesizedTree;
...
public class VSGC3528Test {
    ...
    public void testPreserveParens() throws Exception {
        ...
        try {
            ...
            File file = new File("test/src/org/f3/tools/api/VSGC3528.f3");
            Iterable<? extends JavaFileObject> fileObjects = fileManager.getJavaFileObjects(file);
            F3cTask f3Task = tool.getTask(null, fileManager, dl, List.<String>of("-XDpreserveTrees"), fileObjects);
    ...
    static class ParensFinder extends F3TreeScanner<Void,Object> {
